package com.cclinux.projects.meetpet.service.admin;
...
import com.cclinux.projects.meetpet.comm.ProjectConfig;
...
import com.cclinux.projects.meetpet.service.cust.MeetService;
...
@Service("MeetPetAdminMeetService")
public class AdminMeetService extends BaseMyAdminService {
    ...
    public long insertMeet(MeetModel meet) {
        appError("{宠物服务}该功能暂不开放，如有需要请加作者微信：cclinux0730");
        return 0;
    }
